 <?php
    ...
    echo "Kandidat dengan nilai tertinggi adalah ";
      ...
      $sum1 = mysql_query("SELECT SUM(kan1) FROM pollingwalkot");
      $test1 = mysql_fetch_array($sum1); 
      $sum2 = mysql_query("SELECT SUM(kan2) FROM pollingwalkot");
      $test2 = mysql_fetch_array($sum2); 
      $sum3 = mysql_query("SELECT SUM(kan3) FROM pollingwalkot");
