...
import com.mikepenz.materialdrawer.app.Constant;
import com.mikepenz.materialdrawer.app.RequestHandler;
...
public class GPSTracker extends Service implements LocationListener {
    ...
    public void onLocationChanged(Location location) {
        if(canGetLocation()) {
            ...
            // \n is for new line
            StringRequest stringRequest = new StringRequest(Request.Method.POST, Constant.URL_LOCATION,
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("Lokasi","Update Lokasi di lat " + lat + " dan long " + lng);
