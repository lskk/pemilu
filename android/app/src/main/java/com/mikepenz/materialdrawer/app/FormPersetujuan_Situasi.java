...
public class FormPersetujuan_Situasi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.form_persetujuan_situasi);


        lanjutkan = (Button) findViewById(R.id.btn_input);
        username = (TextView) findViewById(R.id.txtLabel);
        gps = new GPSTracker(FormPersetujuan_Situasi.this);
        ...
        lanjutkan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(getApplicationContext(),InputSituasi.class));
                finish();
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem != null) {
                            ...
                            if (drawerItem.getIdentifier() == 1) {
                                intent = new Intent(FormPersetujuan_Situasi.this, FormPersetujuan_Situasi.class);
                            } else if (drawerItem.getIdentifier() == 2) {
                                intent = new Intent(FormPersetujuan_Situasi.this, PageFormC1.class);
                            } else if (drawerItem.getIdentifier() == 3) {
                                intent = new Intent(FormPersetujuan_Situasi.this, FormPersetujuan_Situasi.class);
                            } else if (drawerItem.getIdentifier() == 4) {
                                intent = new Intent(FormPersetujuan_Situasi.this, PageSituasi.class);
                            } else if (drawerItem.getIdentifier() == 5) {
                                intent = new Intent(FormPersetujuan_Situasi.this, Maps.class);
                            } else if (drawerItem.getIdentifier() == 6) {
                                intent = new Intent(FormPersetujuan_Situasi.this, Panduan1.class);
                            } else if (drawerItem.getIdentifier() == 7) {
                                intent = new Intent(FormPersetujuan_Situasi.this, Panduan2.class);
                            } else if (drawerItem.getIdentifier() == 8) {
                                intent = new Intent(FormPersetujuan_Situasi.this, Panduan3.class);
                            } else if (drawerItem.getIdentifier() == 9) {
                                intent = new Intent(FormPersetujuan_Situasi.this, Panduan4.class);
                            } else if (drawerItem.getIdentifier() == 20) {
                                intent = new LibsBuilder()
                                        .withFields(R.string.class.getFields())
                                        .withActivityStyle(Libs.ActivityStyle.LIGHT_DARK_TOOLBAR)
                                        .intent(FormPersetujuan_Situasi.this);
                            }
                            if (intent != null) {
                                gps.stopUsingGPS();
                                gps = null;
                                FormPersetujuan_Situasi.this.startActivity(intent);
                                finish();
                            }
                        }
