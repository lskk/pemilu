...
public class PageSituasi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page_situasi);
        // Handle Toolbar
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem != null) {
                            ...
                            if (drawerItem.getIdentifier() == 1) {
                                intent = new Intent(PageSituasi.this, FormPersetujuan.class);
                            } else if (drawerItem.getIdentifier() == 2) {
                                intent = new Intent(PageSituasi.this, PageFormC1.class);
                            } else if (drawerItem.getIdentifier() == 3) {
                                intent = new Intent(PageSituasi.this, FormPersetujuan_Situasi.class);
                            } else if (drawerItem.getIdentifier() == 4) {
                                intent = new Intent(PageSituasi.this, PageSituasi.class);
                            } else if (drawerItem.getIdentifier() == 5) {
                                intent = new Intent(PageSituasi.this, Maps.class);
                            } else if (drawerItem.getIdentifier() == 6) {
                                intent = new Intent(PageSituasi.this, Panduan1.class);
                            } else if (drawerItem.getIdentifier() == 7) {
                                intent = new Intent(PageSituasi.this, Panduan2.class);
                            } else if (drawerItem.getIdentifier() == 8) {
                                intent = new Intent(PageSituasi.this, Panduan3.class);
                            } else if (drawerItem.getIdentifier() == 9) {
                                intent = new Intent(PageSituasi.this, Panduan4.class);
                            } else if (drawerItem.getIdentifier() == 20) {
                                intent = new LibsBuilder()
                                        .withFields(R.string.class.getFields())
                                        .withActivityStyle(Libs.ActivityStyle.LIGHT_DARK_TOOLBAR)
                                        .intent(PageSituasi.this);
                            }
                            if (intent != null) {
                                PageSituasi.this.startActivity(intent);
                            }
                        }
...
//              .withShowDrawerUntilDraggedOpened(true)
    ...
    private void getDataGaleri() {
        ...
        String url = PolingHelper.BASE_URL + "get_galeri_situasi";
                                ...
                                try {
                                    ...
                                    if (result.equalsIgnoreCase("true")) {
                                        ...
                                        for (int a = 0; a < jsonArray.length(); a++) {
                                            ...
                                            b.setKeterangan(object.getString("keterangan"));
                                            b.setKabupaten(object.getString("kabupaten"));
                                            b.setKecamatan(object.getString("kecamatan"));
                                            b.setKelurahan(object.getString("kelurahan"));
                                            ...
                                            adapter = new GaleriAdapter(PageSituasi.this, data);
    ...
    private class GaleriAdapter extends BaseAdapter {
        ...
        private class ViewHolder {
            TextView judul, point, username, keterangan;
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (v == null) {
                ...
                v = inflater.inflate(R.layout.item_galeri_situasi, null);
                holder = new ViewHolder();

                holder.username = (TextView) v.findViewById(R.id.txtUsername);
                holder.keterangan = (TextView) v.findViewById(R.id.txtKeterangan);
            ...
            holder.keterangan.setText( "Keterangan :"+ b.getKeterangan());
            ...
            holder.imgGambar.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent newI = new Intent(getApplicationContext(), DetailGaleriSituasi.class);
                    newI.putExtra("id_dok", idDok);
                    newI.putExtra("kabupaten", b.getKabupaten());
                    newI.putExtra("kecamatan", b.getKecamatan());
                    newI.putExtra("kelurahan", b.getKelurahan());
                    newI.putExtra("keterangan", b.getKeterangan());
            ...
            Picasso.with(context).load(PolingHelper.BASE_URL_IMAGE_situasi+b.getFoto_dok()).placeholder(R.drawable.no_image).
